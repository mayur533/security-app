          ...
          <div className="bg-card rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium mb-1">Assigned Geofence ID</label>
                  <input
                    type="number"
                    value={formData.assigned_geofence}
                    onChange={(e) => setFormData({ ...formData, assigned_geofence: e.target.value })}
                    className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
                    placeholder="Enter geofence ID (optional)"
                  />
                </div>
              </div>
